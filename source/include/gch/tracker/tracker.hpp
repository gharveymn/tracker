...
//    tracker_base& operator= (tracker_base&&) noexcept = impl;
      ...
      GCH_NODISCARD rptrs_criter rptrs_rbegin  (void) const noexcept { return m_rptrs.crbegin (); }
      ...
      GCH_NODISCARD rptrs_criter rptrs_rend    (void) const noexcept { return m_rptrs.crend ();   }
