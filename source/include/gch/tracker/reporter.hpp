...
namespace gch
{
  ...
  //  protected:
    ...
    static_assert (std::is_trivially_copyable<reporter_base<tag::reporter_base, tag::reporter_base>>::value, "base was not trivially copyable");
    static_assert (std::is_trivially_copyable<reporter_base<tag::reporter_base, tag::tracker_base>>::value, "base was not trivially copyable");
    static_assert (std::is_trivially_copyable<typename plf::list<int>::iterator>::value, "base was not trivially copyable");
